...
Status DBImpl::FlushMemTableToOutputFile(
  ...
  uint64_t seconds_up1 = immutable_db_options_.SecondsUp();
  ROCKS_LOG_INFO(immutable_db_options_.info_log.get(), "[wjp] {%lu}: Flush Compaction start {%p}", seconds_up1, &flush_job);
  ...
  uint64_t seconds_up2 = immutable_db_options_.SecondsUp();
  ROCKS_LOG_INFO(immutable_db_options_.info_log.get(), "[wjp] {%lu}: Flush Compaction finished {%p} , cost {%f} s", seconds_up2, &flush_job, seconds_up2/1000000.0 - seconds_up1/1000000.0);
  return s;
}
