...
std::string my_stat_output_file = "./log/fillrandom_my_stat.log";
std::string rocksdb_stat_output_file = "./log/fillrandom_rocks_stat.log";
...
void print_my_status(rocksdb::DB* db) {
  ...
  while (true) {
    ...
    outFile << "-------------------->\n";
    outFile << "SecondsUp: " << db->GetOptions().SecondsUp() << endl;
    // 计算网络带宽
